...
#=================================================================================================================
    ...
    def add_user_fields(self):
        ...
        crud_des = Spinner(text='Cajero', values=['Cajero', 'Administrador'])
        crud_submit = Button(text='Añadir',size_hint_x=None,width=100,on_release=lambda x: self.add_user(crud_first.text,crud_last.text,crud_user.text,crud_pwd.text,crud_des.text))
    ...
    def add_product_fields(self):
        ...
        crud_code = TextInput(hint_text='Codigo Prod')
        crud_name = TextInput(hint_text='Nombre Prod')
        crud_weight = TextInput(hint_text='Peso Prod')
        crud_stock = TextInput(hint_text='Prod Stock')
        crud_sold = TextInput(hint_text='Prod Vendido')
        crud_order = TextInput(hint_text='Prod Pedido')
        crud_purchase = TextInput(hint_text='Prod Ultima compra')
        crud_submit = Button(text='Añadir',size_hint_x=None,width=100,on_release=lambda x: self.add_product(crud_code.text,crud_name.text,crud_weight.text,crud_stock.text,crud_sold.text,crud_order.text,crud_purchase.text))
    ...
    def add_user(self, first, last, user, pwd, des):
        ...
        if first == '' or last == '' or user == '' or pwd == '' or des == '':
            self.notify.add_widget(Label(text='[color=#FF0000][b] Todos los campos son obligatorios [/b][/color]',markup=True))
            self.notify.open()
...
#=================================================================================================================
    ...
    def update_user_fields(self):
        ...
        crud_pwd = TextInput(hint_text='Contraseña')
        crud_des = Spinner(text='Cajero', values=['Cajero', 'Administrador'])
        crud_submit = Button(text='Actualizar',size_hint_x=None,width=100,on_release=lambda x: self.update_user(crud_first.text,crud_last.text,crud_user.text,crud_pwd.text,crud_des.text))
    ...
    def update_product_fields(self):
        ...
        crud_code = TextInput(hint_text='Codigo Prod',multiline=False)
        crud_name = TextInput(hint_text='Nombre Prod')
        crud_weight = TextInput(hint_text='Peso Prod')
        crud_stock = TextInput(hint_text='Prod Stock')
        crud_sold = TextInput(hint_text='Prod Vendido')
        crud_order = TextInput(hint_text='Prod Pedido')
        crud_purchase = TextInput(hint_text='Prod Ultima compra')
        crud_submit = Button(text='Actualizar',size_hint_x=None,width=100,on_release=lambda x: self.update_product(crud_code.text,crud_name.text,crud_weight.text,crud_stock.text,crud_sold.text,crud_order.text,crud_purchase.text))
    ...
    def update_product(self,code,name,weight,stock,sold,order,purchase):
        ...
        if code == '':
            self.notify.add_widget(Label(text='[color=#FF0000][b] Codigo necesario [/b][/color]',markup=True))
            self.notify.open()
            Clock.schedule_once(self.killswitch, 1)
        else:
            ...
            if target_code == None:
                ...
                #name,weight,stock,sold,order,purchase
                if name == '':
...
#=================================================================================================================
#=================================---- FUNCIONES ELIMINAR USER/PRD =============================================
#=================================================================================================================

    def remove_user_fields(self):
        target = self.ids.ops_fields
        target.clear_widgets()
        crud_user = TextInput(hint_text='Nombre del usuario')
        crud_submit = Button(text='Eliminar',size_hint_x=None,width=100,on_release=lambda x: self.remove_user(crud_user.text))
        target.add_widget(crud_user)
        target.add_widget(crud_submit)
    ...
    def remove_product_fields(self):
        ...
        crud_submit = Button(text='Eliminar',size_hint_x=None,width=100,on_release=lambda x: self.remove_product(crud_code.text))
        target.add_widget(crud_code)
        target.add_widget(crud_submit)
...
#=================================================================================================================
    ...
    def change_screen(self, instance):
        if instance.text == 'Admin Productos':
            self.ids.scrn_mngr.current = 'scrn_product_content'
        elif instance.text == 'Admin Usuarios':
